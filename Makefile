...
Release: $(DIR_PRO)/Build/output.ulx
	...
	cp $(DIR_PRO)/Build/output.glblorb $(DIR_MAT)/Release/Founder\'s\ Mercy.gblorb
	python tools/blorbtool.py $(DIR_MAT)/Release/Founder\'s\ Mercy.gblorb giload $(DIR_MAT)/Release/interpreter interpreter
